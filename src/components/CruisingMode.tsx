    ...
    <AnimatePresence>
      {isOpen && (
        ...
        >
         ...
         <div className="relative z-10 pt-20 px-6 pb-[calc(1rem+env(safe-area-inset-bottom))] bg-zinc-900/80 backdrop-blur-2xl border-t border-white/10 flex flex-col items-center gap-4">
