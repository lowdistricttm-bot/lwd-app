    ...
    <AnimatePresence>
      {isOpen && (
        ...
        >
         ...
         {/* PTT Button & Quick Alerts Area */}
<div className="relative z-10 pt-6 px-6 pb-[calc(1rem+env(safe-area-inset-bottom))] bg-zinc-900/80 backdrop-blur-2xl border-t border-white/10 flex flex-col items-center gap-8"> 
  {/* ^ Ridotto pb a 1rem per farlo scendere, aumentato gap a 8 per centrare meglio il PTT */}
  ...
  <div className="flex flex-col items-center gap-6 w-full"> {/* Aumentato gap a 6 qui per le segnalazioni */}
