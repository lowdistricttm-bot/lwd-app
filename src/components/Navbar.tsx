...
const Navbar = () => {
  ...
  return (
    <>
      ...
      {isSearchOpen && (
        <div className="fixed inset-0 z-[100] bg-black/95 backdrop-blur-3xl flex flex-col p-6">
      ...
      <AlertDialog open={isRestrictedOpen} onOpenChange={setIsRestrictedOpen}>
        <AlertDialogContent className="bg-zinc-900/90 backdrop-blur-2xl border-white/10 rounded-[2rem]">
          <AlertDialogHeader>
