...
const FollowButton = ({ userId, className }: FollowButtonProps) => {
  ...
  if (checkingFollow) return <div className="flex-1 h-11 bg-white/5 animate-pulse rounded-full" />;
  ...
  return (
    <Button
      ...
      className={cn(
        "rounded-full font-black uppercase italic text-[10px] tracking-widest h-11 px-6 transition-all duration-500 shadow-xl",
        isFollowing 
