      ...
      {isOpen && (
        <>
          ...
          <motion.div 
            ...
            className="fixed inset-x-0 bottom-0 z-[1001] bg-zinc-950 border-t border-white/10 p-6 pt-10 rounded-t-[2.5rem] max-h-[94dvh] overflow-y-auto shadow-[0_-10px_40px_rgba(0,0,0,0.8)]"
            style={{ 
              touchAction: 'pan-y', 
