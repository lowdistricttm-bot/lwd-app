      ...
      {isOpen && (
        <div className="fixed inset-0 z-[999] flex items-center justify-center p-6">
          ...
          <motion.div 
            ...
            className="relative w-full max-w-md bg-zinc-950 border border-white/10 rounded-[2.5rem] overflow-hidden shadow-[0_0_50px_rgba(255,255,255,0.05)]"
          >
            <button 
              onClick={() => { setIsOpen(false); setHasDismissed(true); }}
              className="absolute top-6 right-6 p-2 bg-white/5 text-zinc-500 hover:text-white rounded-full transition-all z-10"
            >
              <X size={20} />
            </button>
            ...
            <div className="p-8 md:p-10 space-y-8">
              <div className="text-center space-y-6">
                <div className="flex justify-center">
                  <div className="w-20 h-20 bg-white text-black rounded-[2rem] flex items-center justify-center rotate-12 shadow-[0_0_30px_rgba(255,255,255,0.2)]">
                    <Gift size={40} className="-rotate-12" />
                  </div>
                </div>
              ...
              <div className="flex items-center justify-between pt-6 border-t border-white/5">
                <div>
                  <p className="text-[8px] font-black uppercase text-zinc-500 tracking-widest mb-1">Prezzo District</p>
                  <p className="text-3xl font-black italic tracking-tighter text-white">€ {activeBox.price}</p>
                </div>
                <div className="text-right">
                  <p className="text-[9px] font-black uppercase text-red-500 tracking-widest animate-pulse mb-1">Solo {activeBox.remaining_quantity} rimaste</p>
              ...
              <Button 
                ...
                className="w-full bg-white text-black hover:bg-zinc-200 h-16 rounded-full font-black uppercase italic tracking-widest shadow-2xl transition-all flex items-center justify-center gap-3 border-none"
              >
