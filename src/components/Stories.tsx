...
const stories = [
  { id: 1, name: 'Your Story', img: 'https://images.unsplash.com/photo-1503376780353-7e6692767b70?auto=format&fit=crop&q=80&w=800', isUser: true },
      ...
      <div className="flex gap-4 overflow-x-auto py-6 px-6 no-scrollbar bg-black border-b border-white/5">
        {stories.map((story, index) => (
          <button 
            ...
            className="flex flex-col items-center gap-2 shrink-0 outline-none group"
          >
            <div className={cn(
              "w-16 h-16 rounded-full p-[2px] transition-all duration-300 group-active:scale-90",
            ...
            <span className="text-[10px] font-bold text-gray-500 truncate w-16 text-center uppercase tracking-tighter">
              {story.name}
            </span>
          </button>
        ))}
