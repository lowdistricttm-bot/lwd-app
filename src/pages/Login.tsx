          ...
          <div className="space-y-8">
            <form onSubmit={handleAuth} className="space-y-6">
              ...
              <Button 
                type="submit" 
                disabled={isLoading}
                className="w-full bg-white/90 backdrop-blur-md text-black hover:bg-zinc-200 rounded-none h-16 font-black uppercase italic tracking-[0.2em] transition-all duration-500 group"
              >
                {isLoading ? (
