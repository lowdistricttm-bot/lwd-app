      ...
      <main className="flex-1 pt-[calc(4rem+env(safe-area-inset-top)+2rem)] pb-32 px-6 max-w-4xl mx-auto w-full">
        <header className="mb-12">
          ...
          <div className="flex items-center gap-4 mb-2">
            ...
            <h2 className="text-zinc-500 text-[10px] font-black uppercase tracking-[0.4em] italic">Wheel Lab</h2>
          </div>
          <h1 className="text-3xl md:text-6xl font-black italic tracking-tighter uppercase">Fitment Calculator</h1>
