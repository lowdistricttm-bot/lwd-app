                        ...
                        <div key={order.id} className="bg-zinc-900/50 border border-white/5 p-6 group hover:border-white/20 transition-all">
                          <div className="flex flex-col md:flex-row justify-between gap-4">
                            <div className="space-y-2">
                              <div className="flex items-center gap-3">
                                <span className="bg-<dyad-write path="src/pages/Profile.tsx" description="Completamento del file Profile.tsx con la visualizzazione corretta del metodo di pagamento 'PAGAMENTO SU WHATSAPP'.">
"use client";
