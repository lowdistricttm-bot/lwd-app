...
import { Loader2, Swords, X, Trophy, Flame, Zap } from 'lucide-react';
        ...
        >
          ...
          <div className="absolute bottom-12 left-8 right-8 md:bottom-20 md:left-12 z-10">
            <motion.div initial={{ x: -20, opacity: 0 }} animate={{ x: 0, opacity: 1 }} transition={{ delay: 0.5 }}>
              <p className="text-[10px] font-black uppercase italic text-zinc-400 mb-1 tracking-widest">Contendente A</p>
        ...
        >
          ...
          <div className="absolute top-12 left-8 right-8 md:top-auto md:bottom-20 md:right-12 z-10 text-right">
            <motion.div initial={{ x: 20, opacity: 0 }} animate={{ x: 0, opacity: 1 }} transition={{ delay: 0.7 }}>
              <p className="text-[10px] font-black uppercase italic text-zinc-400 mb-1 tracking-widest">Contendente B</p>
              <h2 className="text-4xl md:text-6xl font-black italic uppercase tracking-tighter leading-none">
