                ...
                <div className="lg:w-1/3 relative">
                  <div className="aspect-video lg:h-full bg-zinc-950 overflow-hidden">
                    {app.vehicles?.image_url ? (
                      <img src={app.vehicles<dyad-write path="src/pages/AdminApplications.tsx" description="Completamento della pagina admin per la gestione delle selezioni con pulsanti di approvazione e rifiuto.">
"use client";
